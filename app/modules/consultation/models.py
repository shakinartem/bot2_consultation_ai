...
class Consultation(Base):
    ...
    sales_context: Mapped[str | None] = mapped_column(Text)
    consultation_talking_points: Mapped[str | None] = mapped_column(Text)
    result_summary: Mapped[str | None] = mapped_column(Text)
    proposal_text: Mapped[str | None] = mapped_column(Text)
    proposal_package: Mapped[str | None] = mapped_column(String(255))
    proposal_budget_range: Mapped[str | None] = mapped_column(String(255))
    proposal_document_path: Mapped[str | None] = mapped_column(String(500))
